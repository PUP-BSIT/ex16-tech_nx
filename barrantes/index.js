...
function addComment(event) {
  ...
  commentManager.sortComments();
  commentManager.displayComments();

  document.querySelector("#fname").value = "";
  document.querySelector("#comment").value = "";
  document.querySelector("#com_b").disabled = true;
}
...
const commentManager = {
  ...
  sortComments: function(order = "asc") {
    if (order === "asc") {
...
function comment_btn() {
  ...
  let button = document.getElementById("com_b");
...
document.querySelector("#asc_btn").addEventListener("click", function() {
  commentManager.sortComments("asc");
  commentManager.displayComments();
});
document.querySelector("#desc_btn").addEventListener("click", function() {
  commentManager.sortComments("desc");
  commentManager.displayComments();
});
